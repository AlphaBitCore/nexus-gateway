...
proxy=cp.taskforce10x.com:3128, target=https://api2.cursor.sh/aiserver.v1.AiService/StreamUnifiedChatWithTools.
"""
...
def main() -> int:
    ...
    ap.add_argument("--proxy", default="cp.taskforce10x.com:3128")
    ap.add_argument(
        "--target",
    ...
    print(
        f"""
  1. Go to  https://nexus.taskforce10x.com/traffic
