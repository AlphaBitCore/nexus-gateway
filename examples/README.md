...
- Examples assume the seeded super-admin (`admin@nexus.ai / nexus-demo`) for any admin-API call. Use [`tests/lib/auth.sh`](../tests/lib/auth.sh)'s `cp_login` / `cp_curl` helpers for token-managed admin calls.
