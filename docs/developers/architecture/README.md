...
| `packages/ai-gateway/internal/execution/executor/**`, retry policy knobs, provider health, credential breaker attribution | `docs/developers/architecture/services/ai-gateway/recovery-engine-architecture.md` |
