...
func TestWireShapeConstants(t *testing.T) {
	cases := []struct {
		...
		{WireShapeOpenAIVideos, "openai-videos"},
...
func TestKindFromWireShape(t *testing.T) {
	cases := []struct {
		...
		{WireShapeGeminiImagesGenerateContent, EndpointKindImageGeneration},
		{WireShapeOpenAIVideos, EndpointKindVideoGeneration},
		{WireShapeCohereRerank, EndpointKindRerank},
		{WireShapeVoyageRerank, EndpointKindRerank},
