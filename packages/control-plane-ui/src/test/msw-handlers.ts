...
export const mockConfigSync = {
  nodeId: 'node-gw-1',
  targetConfig: { routing: { version: 3 }, hooks: { version: 2 } },
  appliedConfig: { routing: { version: 3 }, hooks: { version: 1 } },
  targetVersion: 3,
  appliedVersion: 2,
  outOfSync: true,
  outOfSyncKeys: ['hooks'],
...
export const mockConfigSyncInSync = {
  nodeId: 'node-gw-1',
  targetConfig: { routing: { version: 3 } },
  appliedConfig: { routing: { version: 3 } },
  targetVersion: 3,
...
export const defaultHandlers = [
  ...
  http.get('/api/admin/nodes/:id/config-sync', () =>
    HttpResponse.json(mockConfigSync),
  ),
