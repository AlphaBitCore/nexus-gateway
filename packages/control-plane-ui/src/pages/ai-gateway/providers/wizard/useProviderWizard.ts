    ...
    try {
      ...
      setModels(
        (detail.models ?? []).map((m) => ({
          ...
          audioInputPrice: m.audioInputPricePerMillion != null ? String(m.audioInputPricePerMillion) : '',
          audioOutputPrice: m.audioOutputPricePerMillion != null ? String(m.audioOutputPricePerMillion) : '',
          cachedAudioInputReadPrice: m.cachedAudioInputReadPricePerMillion != null ? String(m.cachedAudioInputReadPricePerMillion) : '',
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payloadModels = selectedModels.map((m) => ({
        ...
        ...(m.audioInputPrice && { audioInputPricePerMillion: parseFloat(m.audioInputPrice) }),
        ...(m.audioOutputPrice && { audioOutputPricePerMillion: parseFloat(m.audioOutputPrice) }),
        ...(m.cachedAudioInputReadPrice && { cachedAudioInputReadPricePerMillion: parseFloat(m.cachedAudioInputReadPrice) }),
