...
export const ACTION_MAP: Record<string, string> = {
  ...
  // The lifecycle verbs are SEPARATE IAM actions on the Go side
  // (handler.go registers approve / reject / renew / revoke each with its own
  // iamMW), and a role may hold any one of them alone. Mapping them all to
  // `approve` made the UI answer a question nobody asked.
  'virtualKey:approve': 'admin:virtual-key.approve',
  'virtualKey:reject': 'admin:virtual-key.reject',
  'virtualKey:revoke': 'admin:virtual-key.revoke',
  'virtualKey:renew': 'admin:virtual-key.renew',
  'identity-provider:read': 'admin:identity-provider.read',
  'identity-provider:create': 'admin:identity-provider.create',
  'identity-provider:update': 'admin:identity-provider.update',
  'identity-provider:delete': 'admin:identity-provider.delete',
  'identity-provider:probe': 'admin:identity-provider.probe',
  ...
  'alert:read': 'admin:alert.read',
  'alert:create': 'admin:alert.create',
  'alert:update': 'admin:alert.update',
  'alert:delete': 'admin:alert.delete',
  'alert:acknowledge': 'admin:alert.acknowledge',
