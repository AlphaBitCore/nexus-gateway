...
// InspectionResult is the outcome of inspecting an HTTP request body.
type InspectionResult = api.InspectionResult

// RequestInspector is the optional compliance inspection interface.
type RequestInspector = api.RequestInspector

// ResponseInspector is the optional response inspection interface.
type ResponseInspector = api.ResponseInspector

// BodyReadCapper is the optional per-flow body read cap interface.
type BodyReadCapper = api.BodyReadCapper

// ResponseUsageDetector is the optional usage detection interface.
type ResponseUsageDetector = api.ResponseUsageDetector
