...
type Record struct {
	...
	// RequestID is the caller-facing correlation value from
	// X-Nexus-Request-Id, generated by the middleware when absent. It rides
	// on TraceID, where repeating is allowed by design.
	RequestID       string
